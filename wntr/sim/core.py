...
class WNTRSimulator(WaterNetworkSimulator):
    ...
    def run_sim(self, solver_options={}, convergence_error=True):
        ...
        while True:
            ...
            # print ("the initialized X_init is")
            # print (X_init)
            ...
            print ("solver status",solver_status,num_iters)
            # print ("X after solving")
            # print (self._X)
            if solver_status == 0:
            ...
            # print ("=========pre and post controls=========")
            # print (len(presolve_controls_to_run),len(postsolve_controls_to_run))
            ...
            #     print ('\tactivating control {0}'.format(control))
            #     control.run_control_action()
            ...
            #             logger.debug('\t{0}.{1} changed to {2}'.format(obj, attr, getattr(obj, attr)))
            #     print('postsolve controls made changes:')
            #     for obj, attr in self._postsolve_controls.get_changes():
            #         print('\t{0}.{1} changed to {2}'.format(obj, attr, getattr(obj, attr)))
            ...
            print ('no changes made by postsolve controls; moving to next timestep')
    ...
    def _initialize_internal_graph(self):
        ...
        # print ("=================")
        # print (self._internal_graph.todense())
        # print (self._number_of_connections)
